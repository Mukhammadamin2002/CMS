...
$unapproved_comment_counts = mysqli_num_rows($unapproved_comment_query);
 ...
 ?>
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ...
          $element_count = [ $post_counts, $post_published_counts, $post_draft_counts, $comment_counts, $unapproved_comment_counts, $user_counts, $subscriber_count, $categories_counts];
